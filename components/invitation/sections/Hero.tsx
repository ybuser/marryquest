...
export function HeroSection({ groomName, brideName, dateTime, venueName }: HeroSectionProps) {
  ...
  return (
    <section className="relative overflow-hidden rounded-[32px] border border-white/10 bg-gradient-to-b from-[var(--mq-muted)]/50 via-[var(--mq-muted)]/30 to-transparent p-10 shadow-[0_30px_80px_rgba(15,23,42,0.35)] text-center text-[var(--mq-fg)] backdrop-blur-2xl">
