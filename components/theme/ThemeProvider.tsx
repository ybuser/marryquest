...
export function ThemeProvider({ templateKey = 'editorialMagazine', children }: ThemeProviderProps) {
  const selected = useMemo(() => themeTokens[templateKey] ?? themeTokens.editorialMagazine, [templateKey]);
